<?php
    ...
    $res8 = create_user("usernaame","PassWord&isL0nghEn0ugh");
    $res9 = create_user("USERRNAME","PassWord&isL0nghEn0ugh");
    $res10 = create_user("Usern4me","PassWord&isL0nghEn0ugh");
    $res11 = create_user($randomizeUsername,"PassWord&isL0nghEn0ugh");

    $res1["code"] == 4 && $res2["code"] == 4 && $res3["code"] == 4 && $res4["code"] == 4 && $res5["code"] == 4 && $res6["code"] == 4 && $res7["code"] == 4 && $res8["code"] == 0 && $res9["code"] == 0 && $res10["code"] == 0 && $res11["code"] == 0
        ? printf("true")
        : printf("false");
